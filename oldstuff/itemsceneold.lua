...
function scene:enterScene( event )
  ...
  message = display.newText( "You Tapped: " .. params.var1 .." meaning " .. params.var2, 160, 50, 290, 390 )
	message.x = display.contentWidth/2
	message.y = display.contentHeight/2
	group:insert(message)
  
  itemImage = display.newImageRect ( params.var3, 60,60)
  itemImage.x = (display.contentWidth/4) *3 
	itemImage.y = (display.contentHeight/4) 
